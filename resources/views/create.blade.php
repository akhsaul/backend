...
<div class="wrapper">
    ...
    <div class="container" style="margin-top: 50px;">
        <div class="row">
            ...
            <div class="col-lg-6">
                <h3 class="text-center text-danger" style="margin-top: revert"><b>Buat Data {{$category}} Baru</b></h3>
                <div class="form-group">
                    <form action="/post/{{$category}}" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" id="title" name="title" class="form-control m-2" placeholder="Inggrisnya" required
                               aria-required="true">
                        <label for="image">File Gambar</label>
                        <input type="file" id="input-file-now-custom-3 image" class="form-control m-2" name="image" required
                               aria-required="true">
                        <label for="sound">File Suara</label>
                        <input type="file" id="input-file-now-custom-3 sound" class="form-control m-2" name="sound" required
                               aria-required="true">
